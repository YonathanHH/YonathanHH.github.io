  ...
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full min-h-screen">
      ...
      >
        ...
        <div className="bg-white dark:bg-[#22211e] rounded-2xl p-8 md:p-12 shadow-sm border border-[var(--color-primary)]/10">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="mt-10 pt-8 border-t border-[var(--color-primary)]/20">
              <h3 className="text-2xl font-bold mb-4 text-[var(--color-primary)]">Profile Summary</h3>
