...
export default function CV() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full min-h-screen">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
        <h1 className="text-4xl md:text-5xl font-bold mb-12 text-center">Curriculum Vitae</h1>
        
        {/* Experience Section */}
        <section className="mb-16">
          <div className="flex items-center mb-8 pb-2 border-b-2 border-[var(--color-primary)]/20">
            <Briefcase className="text-[var(--color-primary)] mr-3" size={28} />
            <h2 className="text-2xl font-bold">Working Experience</h2>
          </div>
          
          <div className="space-y-10">
            <div className="relative pl-8 border-l-2 border-[var(--color-primary)]/30">
              <div className="absolute w-4 h-4 bg-[var(--color-primary)] rounded-full -left-[9px] top-1"></div>
              <h3 className="text-xl font-bold">Sustainability Reporting Analyst (Volunteer)</h3>
              <p className="text-[var(--color-primary)] font-medium mb-2">eWasteRJ • Oct 2025 to Present</p>
            ...
            <div className="relative pl-8 border-l-2 border-[var(--color-primary)]/30">
              ...
              <p className="text-[var(--color-primary)] font-medium mb-2">Reykjavik University, Iceland • August 2023 to July 2024</p>
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-10">
            <div className="relative pl-8 border-l-2 border-[var(--color-primary)]/30">
              <div className="absolute w-4 h-4 bg-[var(--color-primary)] rounded-full -left-[9px] top-1"></div>
              <h3 className="text-xl font-bold">Data Analysis and Machine Learning</h3>
              <p className="text-[var(--color-primary)] font-medium mb-2">Purwadhika Digital Technology School • Sept 2025 to March 2026</p>
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <div className="relative pl-8 border-l-2 border-[var(--color-primary)]/30">
              <div className="absolute w-4 h-4 bg-[var(--color-primary)] rounded-full -left-[9px] top-1"></div>
              <h3 className="text-xl font-bold">MSc Sustainable Energy Science</h3>
              <p className="text-[var(--color-primary)] font-medium mb-2">Reykjavik University, Iceland • GPA: 3.85 / 4.00 • July 2022 to June 2024</p>
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <div className="relative pl-8 border-l-2 border-[var(--color-primary)]/30">
              <div className="absolute w-4 h-4 bg-[var(--color-primary)] rounded-full -left-[9px] top-1"></div>
              <h3 className="text-xl font-bold">BSc Geology</h3>
              <p className="text-[var(--color-primary)] font-medium mb-2">University of Canterbury, New Zealand • October 2018 to February 2022</p>
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400">
